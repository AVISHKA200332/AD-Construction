        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <nav className="grid grid-cols-1 gap-2 text-gray-200">
              <Link to="/client/dashboard" className="hover:text-[#F5CB5C] transition-colors">Dashboard</Link>
              <Link to="/client/projects" className="hover:text-[#F5CB5C] transition-colors">Projects</Link>
              <Link to="/client/inventory" className="hover:text-[#F5CB5C] transition-colors">Inventory</Link>
              <Link to="/client/reports" className="hover:text-[#F5CB5C] transition-colors">Reports</Link>
              <Link to="/client/settings" className="hover:text-[#F5CB5C] transition-colors">Settings</Link>
            </nav>
          </div>
