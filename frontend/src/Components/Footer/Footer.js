      ...
      <div className="max-w-7xl mx-auto px-6 pt-12 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-5">
              <button type="button" aria-label="Facebook" className="p-2 rounded-lg bg-white/10 hover:bg-white/20 transition">
              ...
              <button type="button" aria-label="Twitter" className="p-2 rounded-lg bg-white/10 hover:bg-white/20 transition">
              ...
              <button type="button" aria-label="LinkedIn" className="p-2 rounded-lg bg-white/10 hover:bg-white/20 transition">
          ...
          <div>
            ...
            <nav className="grid grid-cols-1 gap-2 text-gray-200">
              ...
              <a href="#inventory" className="hover:text-[#F5CB5C] transition-colors">Inventory</a>
              <a href="#reports" className="hover:text-[#F5CB5C] transition-colors">Reports</a>
              <a href="#settings" className="hover:text-[#F5CB5C] transition-colors">Settings</a>
            </nav>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between text-gray-300 text-sm gap-3">
          ...
          <div className="flex items-center gap-4">
            <button type="button" className="hover:text-[#F5CB5C]">Privacy</button>
            <button type="button" className="hover:text-[#F5CB5C]">Terms</button>
